# Support Table // Latex mit Katex in Docsify

## Was ist Katex

Katex stammt von _Latex_ ab - Latex ist ein eigenes Textsatzsystem mit dem Dinge, welche bezüglich Typesetting schwierig umzusetzen sind, in textueller Form abgebildet wird.

Im folgenden eine Liste von Symbolen welche mit Katex direkt unterstützt werden.
